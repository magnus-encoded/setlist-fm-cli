...
| **The step and the turn** | How a photograph moves as the walk goes past it. Two halves, in order. **The step**: it stands in the rank at the wall, and slides in toward the spine as the walk reaches it, standing furthest into the aisle exactly where a tap would take it — so the one nearest the middle is the one you get, and it is the one nothing in front of it hides. **The turn**: past the **Focal plane** it swings round to parallel with the walk and goes by as a hairline, stepping back to the wall as it goes. Turning on the way in as well would say the same thing twice; the turn is the departure. | tilt, rotation, flip, slide |
